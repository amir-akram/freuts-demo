...
export interface HeroSliceDefaultPrimary {
  ...
  /**
   * Jars Image field in *Hero → Default → Primary*
   *
   * - **Field Type**: Image
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.jar_image
   * - **Documentation**: https://prismic.io/docs/fields/image
   */
  jar_image: prismic.ImageField<never>;
  ...
  /**
   * heading low field in *Hero → Default → Primary*
   *
   * - **Field Type**: Rich Text
   * - **Placeholder**: *None*
   * - **API ID Path**: hero.default.primary.heading_low
   * - **Documentation**: https://prismic.io/docs/fields/rich-text
   */
  heading_low: prismic.RichTextField;
}
